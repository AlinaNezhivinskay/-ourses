...
public class OrderService implements IOrderService {
	...
	@Override
	public boolean exportOrders(String filePath, List<Order> orders) throws IOException {
		return FileWorker.writeFile(filePath, Converter.convertOrdersToStrings(orders));
	}

	@Override
	public boolean importOrders(String filePath) throws FileNotFoundException, IOException, ParseException {
		List<Order> orders = Converter.convertStringsToOrders(FileWorker.readFile(filePath),
				GarageRepository.getInstance().getGarages(), MasterRepository.getInstance().getMasters());
